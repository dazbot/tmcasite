	...
	return this.each(function(){
		...
		/*cUp.live('click', function(){
			move(obj, tar, 'up');
                ...
                $(document).on('click', options.controls.up, function() {
                   move(obj, tar, 'down');
                });
                $(document).on('mouseover', options.controls.up, function() {
                    stopTimer(obj);
                });
                $(document).on('mouseleave', options.controls.up, function() {
                    setTimer(obj);
                });
		...
		/*cDown.live('click', function(){
			move(obj, tar, 'down');
                ...
                $(document).on('click', options.controls.down, function() {
                   move(obj, tar, 'up');
                });
                $(document).on('mouseover', options.controls.down, function() {
                    stopTimer(obj);
                });
                $(document).on('mouseleave', options.controls.down, function() {
                    setTimer(obj);
                });
